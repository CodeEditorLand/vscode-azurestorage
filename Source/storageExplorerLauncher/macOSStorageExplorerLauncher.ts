...
export class MacOSStorageExplorerLauncher implements IStorageExplorerLauncher {
	private static subExecutableLocation: string =
		"/Contents/MacOS/Microsoft Azure Storage Explorer";
	...
	private static async getStorageExplorerExecutable(
		...
		return (
			(await callWithTelemetryAndErrorHandling(
				"getStorageExplorerExecutableMac",
				async (context) => {
					const selectedLocation = vscode.workspace
						.getConfiguration("azureStorage")
						.get<string>("storageExplorerLocation");
	...
	private async launchStorageExplorer(
		extraArgs: string[] = [],
	): Promise<void> {
