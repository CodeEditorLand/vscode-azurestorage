...
export async function download(
	...
	const wizardContext: IDownloadWizardContext = {
		...context,
	...
	const wizard: AzureWizard<IDownloadWizardContext> = new AzureWizard(
		wizardContext,
		{
			promptSteps,
			executeSteps: [
				new GetAzCopyDownloadsStep(),
				new DownloadFilesStep(),
			],
...
export async function downloadTreeItems(
	context: IActionContext,
