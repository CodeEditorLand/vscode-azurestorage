...
export async function deleteFilesAndDirectories(
	context: IActionContext,
	treeItem: AzExtTreeItem,
	selection: AzExtTreeItem[] = [],
): Promise<void> {
	const parentContainer = treeUtils.findNearestParent<
		BlobContainerGroupTreeItem | FileShareGroupTreeItem
	>(treeItem, [
