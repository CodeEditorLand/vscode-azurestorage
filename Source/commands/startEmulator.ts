...
import {
	isAzuriteCliInstalled,
	isAzuriteExtensionInstalled,
	warnAzuriteNotInstalled,
} from "../utils/azuriteUtils";
...
export async function startEmulator(
	...
	if (isAzuriteExtensionInstalled()) {
		...
		const emulatorTask: Promise<string> = cpUtils.executeCommand(
			ext.outputChannel,
			undefined,
